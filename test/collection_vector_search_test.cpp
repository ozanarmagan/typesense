...
TEST_F(CollectionVectorTest, TestInvalidVamanaParams) {
    // Test invalid R (non-string)
    nlohmann::json schema_json = R"({
        "name": "test",
        "fields": [
            {"name": "name", "type": "string"},
    ...
    auto collection_create_op = collectionManager.create_collection(schema_json);
    ASSERT_FALSE(collection_create_op.ok());
    ASSERT_EQ("Property `vamana_params.R` must be a positive integer.", collection_create_op.error());

    // Test invalid R (negative)
    schema_json = R"({
        "name": "test",
        "fields": [
            {"name": "name", "type": "string"},
    ...
    // Test invalid L_build (non-string)
    schema_json = R"({
        "name": "test",
        "fields": [
            {"name": "name", "type": "string"},
    ...
    collection_create_op = collectionManager.create_collection(schema_json);
    ASSERT_FALSE(collection_create_op.ok());
    ASSERT_EQ("Property `vamana_params.L_build` must be a positive integer.", collection_create_op.error());

    // Test invalid L_build (negative)
    schema_json = R"({
        "name": "test",
        "fields": [
            {"name": "name", "type": "string"},
    ...
    collection_create_op = collectionManager.create_collection(schema_json);
    ASSERT_FALSE(collection_create_op.ok());
    ASSERT_EQ("Property `vamana_params.alpha` must be a positive number.", collection_create_op.error());
...
TEST_F(CollectionVectorTest, TestVamanaParamsSummaryJSON) {
    nlohmann::json schema_json = R"({
        "name": "test",
        "fields": [
            {"name": "name", "type": "string"},
    ...
    ASSERT_TRUE(summary["fields"][1]["vamana_params"].is_object());
    ASSERT_EQ(64, summary["fields"][1]["vamana_params"]["R"].get<uint32_t>());
    ASSERT_EQ(100, summary["fields"][1]["vamana_params"]["L_build"].get<uint32_t>());
    ASSERT_FLOAT_EQ(1.2, summary["fields"][1]["vamana_params"]["alpha"].get<float>());
    ASSERT_EQ(0, summary["fields"][0].count("vamana_params"));
}
